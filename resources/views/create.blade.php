      ...
      <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
		 ...
		 <div class="col-md-10 pl-5 p-10 pt-5">
          <h3><i class="fas fa-id-card"></i> DATA PELANGGAN </h3><hr>
			<a href="/dtplg"> Kembali</a>
			
			<br/>
			<br/>
		 
			<form action="/dtplg/store" method="post">
				{{ csrf_field() }}
				ID  :
				<p></p> <input type="int" name="id",10 required="required"> <br/>
				Nama  :
				<p></p> <input type="text" name="nama_plg" required="required"> <br/>
				TTL   :
				<p></p> <input tytpe="text" name="TTL" required="required"> <br/>
				Alamat: 
				<p></p><textarea name="Alamat" required="required"></textarea> <br/>
				Email :
				<p></p> <input type="text" name="Email" required="required"> <br/>
