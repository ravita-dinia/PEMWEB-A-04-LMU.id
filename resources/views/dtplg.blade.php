  ...
  <body>
      ...
      <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 pl-5 p-10 pt-5">
          ...
          <a href="{{ url ('dtplg/create')}}" class="btn btn-primary mb-3"> Tambah Data</a>
          <table class="table table-striped table-bordered pr-5">
              ...
              <tr>
                ...
                <td>{{ $c->Alamat }}</td>
                 <td>{{ $c->Email }}</td>
                <td>
                  <a href="/dtplg/edit/{{ $c->id }}">Edit</a>
                  |
                  <a href="/dtplg/hapus/{{ $c->id }}">Hapus</a>
                </td>
              </tr>
              @endforeach
            </table>
             ...
             <!--  <tbody>
                <tr>
                  ...
                  <td>123</td>
                  <td>Ardi Kusuma</td>
                  <td>Surabaya, 2 Desember 1999</td>
                  <td>Surabaya</td>
                ...
                <tr>
                  <th scope="row">3</th>
                   <td>125</td>
                  <td>Dini Permata</td>
                  <td>Jombang, 16 Desember 1996</td>
                  <td>Surabaya</td>
