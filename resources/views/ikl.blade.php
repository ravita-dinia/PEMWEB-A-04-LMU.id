      ...
      <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
		 ...
		 <div class="col-md-10 pl-5 p-10 pt-5">
          <h3><i class="fas fa-id-card"></i> Mengelola Iklan </h3><hr>
			
          <a href="{{ url ('ikl/create')}}" class="btn btn-primary mb-3"> Tambah Data</a>
          <table class="table table-striped table-bordered pr-5">
              ...
              <tr>
                <td>{{ $a->id_iklan }}</td>
                <td>{{ $a->nama_iklan }}</td>
                <td>{{ $a->deskripsi_iklan }}</td>
                <td>{{ $a->biaya_iklan }}</td>
                <td>
                  <a href="/ikl/editikl/{{ $a->id_iklan }}">Edit</a>
                  |
                  <a href="/ikl/hapusikl/{{ $a->id_iklan }}">Hapus</a>
                </td>
              </tr>
              @endforeach
            </table>
