...
<html lang="en">
  ...
  <div class="row mb-2">
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-primary">Masukkan Artikel</strong>
          <h3 class="mb-0">Artikel</h3>
          <p class="card-text mb-auto">Unggah artikel informasi tentang musik anda di sini.</p>
          <!-- <a href="unggahartikel" class="stretched-link">Klik di sini</a> -->
        </div>
    ...
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-success">Masukkan Kursus Musik</strong>
          <h3 class="mb-0">Musik</h3>
          <p class="mb-auto">Unggah kursus musikmu di sini.</p>
          <a href="unggahkursus" class="stretched-link">Klik di sini</a>
        </div>
        <div class="col-auto d-none d-lg-block">
          <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar bg">
      <a class="navbar-brand" href="#">Unggah Artikel</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
       </button>
