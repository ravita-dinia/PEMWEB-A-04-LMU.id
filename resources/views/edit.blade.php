      ...
      <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
		 ...
		 <div class="col-md-10 pl-5 p-10 pt-5">
          <h3><i class="fas fa-id-card"></i> EDIT PELANGGAN </h3><hr>
			...
			<form action="/dtplg/update" method="post">
				...
				Nama :
        <p></p> <input type="text" required="required" name="Nama" value="{{ $c->nama_pelanggan }}"> <br/>
				TTL :
        <p></p> <input type="text" required="required" name="TTL" value="{{ $c->TTL }}"> <br/>
				Alamat :
        <p></p> <textarea required="required" name="Alamat">{{ $c->Alamat }}</textarea> <br/>
				Email :
        <p></p> <input type="text" required="required" name="Email" value="{{ $c->Email }}"> <br/>
